  ...
  const handleFileUpload = async (file) => {
    ...
    try {
      const response = await axios.post(
        "https://musesnap.onrender.com/api/uploads/images", // Updated backend API endpoint
        formData,
        {
          headers: {
      ...
      const imageUrl = `https://musesnap.onrender.com/api/uploads/images/${uploadedImageId.trim()}`; // Updated endpoint
